...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://patrycja05.github.io/";
    private static final String DELETE_BUTTON = "/html/body/main/section[2]/div/form[1]/div/fieldset[1]/button[4]";
    ...
    private boolean checkTaskExistsInTrello (String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("patrycjacaka");
        driverTrello.findElement(By.id("password")).sendKeys("Haslotestowe1.");
